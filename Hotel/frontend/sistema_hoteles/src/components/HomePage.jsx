...
import Rating from './Rating'; // Asegúrate de tener este componente para mostrar el rating
...
const HotelDetailsPage = () => {
  const [comments, setComments] = useState(["Buena atención", "Excelente vista", "Perfecto para familias"]); // Comentarios de ejemplo
