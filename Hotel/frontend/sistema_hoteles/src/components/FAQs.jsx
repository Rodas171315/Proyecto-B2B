...
function FAQs() {
  ...
  useEffect(() => {
    ...
    async function fetchFaqs() {
        const response = await fetch('http://35.211.214.127:8080/faqs');
    ...
    async function fetchSeccionesGenerales() {
        const response = await fetch('http://35.211.214.127:8080/secciones-generales');
        const data = await response.json();
    ...
    async function handleSubmitFaq(e) {
        e.preventDefault();
        const url = faqEdit.id ? `http://35.211.214.127:8080/faqs/${faqEdit.id}` : 'http://35.211.214.127:8080/faqs';
    ...
    async function handleSubmitSeccion(e) {
        e.preventDefault();
        const url = seccionEdit.id ? `http://35.211.214.127:8080/secciones-generales/${seccionEdit.id}` : 'http://35.211.214.127:8080/secciones-generales';
    ...
    async function deleteFaq(id) {
        await fetch(`http://35.211.214.127:8080/faqs/${id}`, { method: 'DELETE' });
        fetchFaqs(); // Refetch FAQs
    }

    // Delete Sección General
    async function deleteSeccion(id) {
        await fetch(`http://35.211.214.127:8080/secciones-generales/${id}`, { method: 'DELETE' });
        fetchSeccionesGenerales(); // Refetch Secciones Generales
    }
